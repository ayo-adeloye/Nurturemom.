(() => {
  ...
  function plusActive() {
    return document.body?.dataset?.nmPlus === 'active';
  }
  ...
  function ensureModal() {
    ...
    modal.innerHTML = `
      <section class="nm-circle-sheet" role="dialog" aria-modal="true" aria-labelledby="nmCircleTitle">
        <p class="nm-circle-kicker">NURTUREMOM COMMUNITY · PRIVATE PROTOTYPE</p>
        ...
        <p class="nm-circle-safety">Prototype only: no real members are being matched yet. A production community would require verified adult accounts, mutual consent for private messaging, block/report controls, moderation, and no automatic sharing of Recovery, Companion, Village, or exact-location data.</p>
      </section>`;
  ...
  function showPrototypeMatch() {
    ...
    result.innerHTML = `
      <div class="nm-circle-result">
        <p class="nm-circle-kicker">YOUR PROTOTYPE MATCH</p>
  ...
  function injectCard() {
    ...
    card.innerHTML = `
      <p class="nm-circle-kicker">MOM-TO-MOM COMMUNITY · PROTOTYPE</p>
      ...
      <button type="button" class="nm-circle-btn">Find a circle that fits me</button>
  ...
  function render() {
    ...
    renderTimer = setTimeout(injectCard, 90);
  }
